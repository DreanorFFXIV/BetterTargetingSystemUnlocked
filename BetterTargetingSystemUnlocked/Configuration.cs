...
using BetterTargetingSystemUnlocked.Keybinds;
using System;
...
public class Configuration : IPluginConfiguration
{
    ...
    public float NinLBPercentage { get; set; } = 45;
    ...
    public Keybind NinjaOneshotLB { get; set; } = new Keybind(null, false, false, false);
