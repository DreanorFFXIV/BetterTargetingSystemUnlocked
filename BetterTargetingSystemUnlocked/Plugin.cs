...
using BetterTargetingSystemUnlocked.Windows;
using System;
...
namespace BetterTargetingSystemUnlocked;

public sealed unsafe class Plugin : IDalamudPlugin
{
    public string Name => "Better Targeting System Unlocked";
    ...
    private WindowSystem WindowSystem = new("BetterTargetingSystemUnlocked");
